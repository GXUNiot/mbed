...
/** ADS1115 模数转换模块 16位4通道ADC
 *
 *	特征描述
 *	1.宽电源范围：2.0V至5.5V
 *	2.低电流消耗：连续模式：仅150μA单次模式：自动关闭
 *	3.可编程数据速率：8SPS至860SPS
 *	4.内部低漂移参考电压
 *	5.内部振荡器
 *	6.内部PGA（可编程增益放大器）
 *	7. I2C接口：引脚可选地址
...
public:
    ADS1015(I2C* i2c = 0, uint8_t i2cAddress = ADS1015_ADDRESS); // set i2c adress = 0 to allow ADS1115 to use this as default constructor
